...
const Aboutus = () => {
  const pageDescription = "Şekir Yapı, Bursa ve çevresinde güvenilir, kaliteli ve estetik PVC Cam Balkon ve alüminyun üretim tesisi olarak sizlere çözümler sunan bir markadır.";
  const pageKeywords = "Hakkımızda, Şekir Yapı, PVC, Cam Balkon, Alüminyum Doğrama Üretim Tesisi";
              ...
              <div className="aboutus-video">
                ...
                >
                  <img
                    ...
                    src="assets/images/hakkimizda/hakkimiz-3.webp"
                    data-src="assets/images/hakkimizda/hakkimiz-3.webp"
                    alt="hakkimizda"
                    title="hakkimizda"
                  />
                ...
                <FsLightbox
                  ...
                  sources={["https://www.youtube.com/embed/DaFEgCME_N4"]}
                />
              </div>
            </div>
          </div>
