        ...
        <section className="page-header">
          ...
          <div className="container">
            ...
            <h2 className="page-header__title">
              CAFFEİNE %5 + PEPTİDES + HYALÜRONİK ASİT GÖZ ÇEVRESİ SERUMU
            </h2>
          </div>
        </section>
                ...
                <div className="product-details__content">
                  <div className="product-details__top">
                    <h3 className="product-details__title">
                      CAFFEİNE %5 + PEPTİDES + HYALÜRONİK ASİT GÖZ ÇEVRESİ
                      SERUMU
                  ...
                  <div className="product-details__excerpt">
                    <p className="list-unstyled product-details__description__lists">
                      <ul className="list-unstyled product-details__description__lists">
                        ...
                        İçerdiği yüksek oranda kafein, 5 farklı molekül boyutu
                        ile hyalüronik asit ve 3 farklı aktif peptit ile göz
                        çevresindeki koyu halka ve şişkinlik görünümünün
                        azalmasına ve aydınlık bir görünüm kazanılmasına
                        yardımcı olur.
                        <li>
                        ...
                        direkt temasından kaçınınız. Temas halinde bol su
                        ile durulayınız. Çocukların ulaşamayacağı bir
