      ...
      <SRLWrapper>
        <section className="page-header">
          ...
          <div className="container">
            ...
            <h2 className="page-header__title">HYALÜRONİK ASİT NEMLENDİRİCİ YÜZ VE VÜCUT CİLT BAKIM KREMİ</h2>
          </div>
        </section>
            ...
            <div className="row">
              ...
              >
                <div className="product-details__img">
                  <img
                    src="assets/images/lopren/yüz-vucut-cilt-bakim-kremi.jpg"
                    alt=""
                  />
                  <div className="product-details__img-search">
                    <a
                      className="img-popup"
                      href="assets/images/lopren/yüz-vucut-cilt-bakim-kremi.jpg"
                    ></a>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="product-details__content">
                  <div className="product-details__top">
                    ...
                    HYALÜRONİK ASİT NEMLENDİRİCİ YÜZ VE VÜCUT CİLT BAKIM KREMİ
                  ...
                  <div className="product-details__excerpt">
                    <p className="list-unstyled product-details__description__lists">
                      <ul className="list-unstyled product-details__description__lists">
                        ...
                        Cildi nemlendirir, Nem dengesinin korunmasına yardımcı
                        olur, Düzenli kullanımda ince çizgi ve kırışıklık
                        görünümünü azaltır, Cilde ışıltı kazandırır, Göz
                        çevresini nemlendirir.
                        <li>
