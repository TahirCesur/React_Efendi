...
function BitkiselUrunlerBaproyBitkiselCamasirYumusatici() {
        ...
        <section className="page-header">
          ...
          <div className="container">
            ...
            <h2 className="page-header__title">
              {t("BAPROY BİTKİSEL ÇAMAŞIR YUMUŞATICI")}
            </h2>
          </div>
        </section>
            ...
            <div className="row">
              ...
              >
                <div className="product-details__img">
                  <img
                    src="assets/images/bitkisel/bitkisel-camasir-yumusatici.webp"
                    alt="BAPROY BİTKİSEL ÇAMAŞIR YUMUŞATICI"
                  />
                  <div className="product-details__img-search">
                    <a
                      className="img-popup"
                      href="assets/images/bitkisel/bitkisel-camasir-yumusatici.webp"
                    ></a>
                  </div>
                </div>
              </div>
...
export default BitkiselUrunlerBaproyBitkiselCamasirYumusatici;
