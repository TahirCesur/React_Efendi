        ...
        <section className="page-header">
          ...
          <div className="container">
            ...
            <h2 className="page-header__title">
              HYALÜRONİK ASİT VE KOLAJEN YAŞLANMA KARŞITI CİLT BAKIM SERUMU
            </h2>
          </div>
        </section>
                ...
                <div className="product-details__content">
                  <div className="product-details__top">
                    <h3 className="product-details__title">
                      HYALÜRONİK ASİT VE KOLAJEN YAŞLANMA KARŞITI CİLT BAKIM
                      SERUMU
                  ...
                  <div className="product-details__excerpt">
                    <p className="list-unstyled product-details__description__lists">
                      <ul className="list-unstyled product-details__description__lists">
                        ...
                        Hyalüronik Asit ile cildi nemlendirir, kolajen ile
                        sıkılaştırmaya, yaşlanma belirtilerine karşı korumaya
                        yardımcı olur. Cilt yumuşak, pürüzsüz ve ışıltılı bir
                        görünüm kazanır.
                        <li>
