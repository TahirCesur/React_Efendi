...
const ProductCarouselWinsa = (props) => {
  const {title1,title2,title3,nav1,nav2,nav3,picture1,picture2,picture3,title4,title5,title6,nav4,nav5,nav6,picture4,picture5,picture6}=props;
...
export default ProductCarouselWinsa;
