        ...
        <section className="page-header">
          ...
          <div className="container">
            ...
            <h2 className="page-header__title">
              HASSAS VE ATOPİK CİLTLER İÇİN YÜZ YIKAMA JELİ
            </h2>
          </div>
        </section>
            ...
            <div className="row">
              ...
              >
                <div className="product-details__img">
                  <img
                    src="assets/images/lopren/hassas-cilt-yuz-yikama-jeli.jpg"
                    alt=""
                  />
                  <div className="product-details__img-search">
                    <a
                      className="img-popup"
                      href="assets/images/lopren/hassas-cilt-yuz-yikama-jeli.jpg"
                    ></a>
                  </div>
                </div>
              </div>
                  ...
                  <div className="product-details__excerpt">
                    <p className="list-unstyled product-details__description__lists">
                      <ul className="list-unstyled product-details__description__lists">
                        ...
                        Jel, nazik formülüyle hassas ciltleriçin özel olarak
                        üretilmiştir. İçerisinde bulunan bitkisel özler ve
                        proteinler sayesinde cildi yağ, kir ve makyaj
                        kalıntılarından temizleyerek arındırır. Cilde nem ve
                        canlılık kazandırır. Hassas ciltlere özel formüle
                        edildiği için tüm cilt tiplerinin kullanımına uygun bir
                        üründür.
                        <li>
