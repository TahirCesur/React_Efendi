...
function TemizlikAlkolBazliYuzeyTemizleme() {
      ...
      <SRLWrapper>
        <section className="page-header">
          ...
          <div className="container">
            ...
            <h2 className="page-header__title">{t("ALKOL BAZLI YÜZEY TEMİZLEME MADDESİ")}</h2>
          </div>
        </section>
            ...
            <div className="row">
              ...
              >
                <div className="product-details__img">
                  <img
                    src="assets/images/endustriyeltemizlik/alkol-bazli-yuzey-temizleme-maddesi.webp"
                    alt="ALKOL BAZLI YÜZEY TEMİZLEME MADDESİ"
                  />
                  <div className="product-details__img-search">
                    <a
                      className="img-popup"
                      href="assets/images/endustriyeltemizlik/alkol-bazli-yuzey-temizleme-maddesi.webp"
                    ></a>
                  </div>
                </div>
              </div>
                ...
                <div className="product-details__content">
                  <div className="product-details__top">
                    <h3 className="product-details__title">
                      {t("ALKOL BAZLI YÜZEY TEMİZLEME MADDESİ")}
                      <span className="product-details__price">{t("G-201")}</span>
                    </h3>
                  </div>
...
export default TemizlikAlkolBazliYuzeyTemizleme;
