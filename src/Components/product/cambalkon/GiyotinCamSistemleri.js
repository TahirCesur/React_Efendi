...
import data from "../../../data/giyotin.json";
...
function GiyotinCamSistemleri() {
  const pageDescription = "";
  const pageKeywords = "Giyotin Cam Sistemleri";

  const [canonicalUrl, setCanonicalUrl] = useState("");

  useEffect(() => {
    const dynamicCanonicalUrl = "https://sekiryapi.com.tr/#/giyotin-cam-sistemleri";
  ...
  return (
    <>
      <Helmet>
        <title>{t("Giyotin Cam Sistemleri")}</title>
            ...
            <div className="blog-page">
              <Container data-aos="fade-up">
                ...
                <Row>
                  ...
                  />
                  {data.map((giyotin) => {
                    const { picture, id, nav, price } = giyotin;
                    const title = t(giyotin.title);
...
export default GiyotinCamSistemleri;
