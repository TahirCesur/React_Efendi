...
import data from "../../../data/surgulu.json";
...
function SurguluCamSistemleri() {
  const pageDescription = "";
  const pageKeywords = "Sürgülü Cam Sistemleri";

  const [canonicalUrl, setCanonicalUrl] = useState("");

  useEffect(() => {
    const dynamicCanonicalUrl = "https://sekiryapi.com.tr/#/surgulu-cam-sistemleri";
  ...
  return (
    <>
      <Helmet>
        <title>{t("Sürgülü Cam Sistemleri")}</title>
            ...
            <div className="blog-page">
              <Container data-aos="fade-up">
                ...
                <Row>
                  ...
                  />
                  {data.map((surgulu) => {
                    const { picture, id, nav, price } = surgulu;
                    const title = t(surgulu.title);
...
export default SurguluCamSistemleri;
