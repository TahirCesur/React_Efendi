...
function CamBalkon() {
  const pageDescription = "Cam balkon sistemi Prestijli sistemlerimizin içinde olup yuvarlak, köşeli, açılı, oval balkonlarınızda özel ray ve teker tasarımları sayesinde balkonunuzu istediğinizde çok rahat açıp kapatarak kullanabilirsiniz. ";
  const pageKeywords = "Cam Balkon Sistemleri";

  const [canonicalUrl, setCanonicalUrl] = useState("");

  useEffect(() => {
    const dynamicCanonicalUrl = "https://sekiryapi.com.tr/#/cam-balkon";
  ...
  return (
    <>
      <Helmet>
        <title>{t("Cam Balkon Sistemleri")}</title>
