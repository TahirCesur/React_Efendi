...
import data from "../../../data/kisbahcesi.json";
...
function KisBahcesi() {
  ...
  const pageKeywords = "Kış Bahçesi";

  const [canonicalUrl, setCanonicalUrl] = useState("");

  useEffect(() => {
    const dynamicCanonicalUrl = "https://sekiryapi.com.tr/#/kis-bahcesi";
            ...
            <div className="blog-page">
              <Container data-aos="fade-up">
                ...
                <Row>
                  ...
                  />
                  {data.map((kisbahcesi) => {
                    const { picture, id, nav, price } = kisbahcesi;
                    const title = t(kisbahcesi.title);
