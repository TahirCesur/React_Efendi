...
const KlasikGiyotinSistem = () => {
  const pageDescription = "Klasik Giyotin Sistemlerde kullanılan tüm ürünler hammadde kalitesinin özelliğinden güneş, yağmur, soğuk, kar gibi dış hava koşullarından etkilenmeden uzun yıllar kullanabilirsiniz.";
  const pageKeywords = "Klasik Giyotin Cam Sistemleri";

  const [canonicalUrl, setCanonicalUrl] = useState("");

  useEffect(() => {
    const dynamicCanonicalUrl = "https://sekiryapi.com.tr/#/klasik-giyotin-sistem";
  ...
  return (
    <>
      <Helmet>
        <title>{t("Klasik Giyotin Cam Sistemleri")}</title>
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-store-features p-5">
                <ProductCarousel
                  title1={t("Klasik Giyotin Cam Sistemleri")}
                  picture1="assets/images/cam-balkon/giyotin/70.webp"
                  title2={t("Klasik Giyotin Cam Sistemleri")}
                  picture2="assets/images/cam-balkon/giyotin/71.webp"
                  title3={t("Klasik Giyotin Cam Sistemleri")}
                  picture3="assets/images/cam-balkon/giyotin/77.webp"
                  title4={t("Klasik Giyotin Cam Sistemleri")}
                  picture4="assets/images/cam-balkon/giyotin/78.webp"
                  title5={t("Klasik Giyotin Cam Sistemleri")}
                  picture5="assets/images/cam-balkon/giyotin/79.webp"
                  title6={t("Klasik Giyotin Cam Sistemleri")}
                  picture6="assets/images/cam-balkon/giyotin/80.webp"
                />
              </div>

              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-info-details pt-5">
                <ProductCarouselTitleSlogan
                  title={t("Klasik Giyotin Cam Sistemleri")}
                  slogan={t("")}
                />
                ...
                <ul className="d-flex flex-column pro-lists product-price-info">
                  <ProductCarouselDescCam
                    ...
                    desc2={t(
                      "Klasik Giyotin Sistemlerde kullanılan tüm ürünler hammadde kalitesinin özelliğinden güneş, yağmur, soğuk, kar gibi dış hava koşullarından etkilenmeden uzun yıllar kullanabilirsiniz."
                    )}
                    desc3={t(
...
export default KlasikGiyotinSistem;
