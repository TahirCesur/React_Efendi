...
const EsiksizSurguluSistem = () => {
  const pageDescription = "Eşiksiz Sürgülü Sistem, balustradların üzerinde belli bir yüksekliği olan veya yoğun ve geçişi olmayan projelerde kullanılabilen bir sistemdir ve kullanımı oldukça kolaydır. Diğer cam balkonlarda, özellikle kadınlar, cam kanatların ağır ve cam olması nedeniyle açma-kapama sırasında rahatsız olabilirler. ";
  const pageKeywords = "Eşiksiz Sürgülü Cam Sistemleri";

  const [canonicalUrl, setCanonicalUrl] = useState("");

  useEffect(() => {
    const dynamicCanonicalUrl = "https://sekiryapi.com.tr/#/esiksiz-surgulu-sistem";
  ...
  return (
    <>
      <Helmet>
        <title>{t("Eşiksiz Sürgülü Cam Sistemleri")}</title>
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-store-features p-5">
                <ProductCarousel
                  title1={t("Eşiksiz Sürgülü Cam Sistemleri")}
                  picture1="assets/images/cam-balkon/surgulu-cam/50.webp"
                  title2={t("Eşiksiz Sürgülü Cam Sistemleri")}
                  picture2="assets/images/cam-balkon/surgulu-cam/51.webp"
                  title3={t("Eşiksiz Sürgülü Cam Sistemleri")}
                  picture3="assets/images/cam-balkon/surgulu-cam/52.webp"
                  title4={t("Eşiksiz Sürgülü Cam Sistemleri")}
                  picture4="assets/images/cam-balkon/surgulu-cam/53.webp"
                  title5={t("Eşiksiz Sürgülü Cam Sistemleri")}
                  picture5="assets/images/cam-balkon/surgulu-cam/45.webp"
                  title6={t("Eşiksiz Sürgülü Cam Sistemleri")}
              ...
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-info-details pt-5">
                <ProductCarouselTitleSlogan
                  title={t("Eşiksiz Sürgülü Cam Sistemleri")}
                  slogan={t("")}
                />
                ...
                <ul className="d-flex flex-column pro-lists product-price-info">
                  <ProductCarouselDescCam
                    ...
                    desc1={t(
                      "Eşiksiz Sürgülü Sistem yerden belli bir yüksekliği olan küpeşte üzerlerinde ya da işlek ve geçişi olmayan projelerde kullanabileceğiniz bir sistem olup kullanımı çok kolaydır. Diğer cam balkonlarda cam kanatların ağır ve cam olması sebebiyle açıp kapatırken özellikle hanımefendiler bu durumdan rahatsız olmaktadırlar bu sebeple Eşiksiz Sürgülü Sistem bu anlamda kullanıma daha uygun bir sistemdir."
                    )}
                    title2={t("Cam Balkon Aksesuarları")}
                    desc2={t(
                      "Eşiksiz Sürgülü Sistemlerde kullanılan tüm ürünler hammadde kalitesinin özelliğinden güneş, yağmur, soğuk, kar gibi dış hava koşullarından etkilenmeden uzun yıllar kullanabilirsiniz."
                    )}
                    desc3={t(
                    ...
                    desc4={t(
                      "Eşiksiz Sürgülü Sistemlerde cam kanat tekerlerinin üstte kılavuzlanmasını sağlayan kasa profili (ray profili) itina ile yapılan yük taşıma testleri sonucunda beş kanallı olarak üretilmiş ve dizayn edilmiştir."
                    )}
                  />
                </ul>
              </div>
...
export default EsiksizSurguluSistem;
