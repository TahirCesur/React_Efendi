...
const KilavuzsuzKupesteliCamBalkon = () => {
  const pageDescription = "Kılavuzsuz Küpeşteli Cam Balkon Sistemleri balkonunuza hem estetik görüntü hem de perde takabilme olanağı sağlamaktadır. ";
  const pageKeywords = "Kılavuzsuz Küpeşteli Cam Balkon Sistemleri";

  const [canonicalUrl, setCanonicalUrl] = useState("");

  useEffect(() => {
    const dynamicCanonicalUrl = "https://sekiryapi.com.tr/#/kilavuzsuz-kupesteli-cam-balkon";
  ...
  return (
    <>
      <Helmet>
        <title>{t("Kılavuzsuz Küpeşteli Cam Balkon Sistemleri")}</title>
        ...
        <div className="product-single mb-5">
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-info-details pt-5">
                <ProductCarouselTitleSlogan
                  title={t("Kılavuzsuz Küpeşteli Cam Balkon Sistemleri")}
                  slogan={t("")}
                />
                ...
                <ul className="d-flex flex-column pro-lists product-price-info">
                  <ProductCarouselDescCam
                    ...
                    desc1={t(
                      "Kılavuzsuz Küpeşteli Cam Balkon Sistemleri balkonunuza hem estetik görüntü hem de perde takabilme olanağı sağlamaktadır. Diğer piyasa sistemleri gibi kısa zamanda çalışmama, açılmama, yürümeme, kapanmama gibi zorluklar yaşanmaz. Uzun yıllar kullanımı garanti eden bir sistemdir."
                    )}
            ...
            <div className="row mt-0">
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-store-features p-5">
                <ProductCarouselOne
                  title1={t("Kılavuzsuz Küpeşte Aparatı")}
              ...
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-info-details pt-5">
                <ProductCarouselTitleSlogan
                  title={t("Kılavuzsuz Küpeşte Aparatı")}
                ...
                <ul className="d-flex flex-column pro-lists product-price-info">
                  <ProductCarouselDescOne
                    title1={t("Kılavuzsuz Küpeşte Aparatı")}
                    desc1={t(
                      "Özel Kılavuzsuz Küpeşteli Cam birleşim yerlerinde ve maximum her 4 mt de kullanılmalıdır. İstenilen desende ve projeye uygun olarak özel aparat üretimi yapılır."
                    )}
                  />
                </ul>
              </div>
...
export default KilavuzsuzKupesteliCamBalkon;
