...
const KilavuzsuzEsiksizCamBalkon = () => {
  ...
  useEffect(() => {
    const dynamicCanonicalUrl = "https://sekiryapi.com.tr/#/kilavuzsuz-esiksiz-cam-balkon";
  ...
  return (
    <>
      <Helmet>
        <title>{t("Kılavuzsuz Eşiksiz Cam Balkon Sistemleri")}</title>
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-store-features p-5">
                <ProductCarousel
                  title1={t("Kılavuzsuz Eşiksiz Cam Balkon Sistemleri")}
                  picture1="assets/images/cam-balkon/katlanir-cam-balkon-sistemi/kcs/7.webp"
                  title2={t("Kılavuzsuz Eşiksiz Cam Balkon Sistemleri")}
                  picture2="assets/images/cam-balkon/katlanir-cam-balkon-sistemi/kcs/8.webp"
                  title3={t("Kılavuzsuz Eşiksiz Cam Balkon Sistemleri")}
                  picture3="assets/images/cam-balkon/katlanir-cam-balkon-sistemi/kcs/9.webp"
                  title4={t("Kılavuzsuz Eşiksiz Cam Balkon Sistemleri")}
                  picture4="assets/images/cam-balkon/katlanir-cam-balkon-sistemi/kcs/10.webp"
                  title5={t("Kılavuzsuz Eşiksiz Cam Balkon Sistemleri")}
                  picture5="assets/images/cam-balkon/katlanir-cam-balkon-sistemi/kcs/11.webp"
                  title6={t("Kılavuzsuz Eşiksiz Cam Balkon Sistemleri")}
                  picture6="assets/images/cam-balkon/katlanir-cam-balkon-sistemi/kcs/12.webp"
                />
              </div>

              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-info-details pt-5">
                <ProductCarouselTitleSlogan
                  title={t("Kılavuzsuz Eşiksiz Cam Balkon Sistemleri")}
                  slogan={t("")}
                />
                ...
                <ul className="d-flex flex-column pro-lists product-price-info">
                  <ProductCarouselDescCam
                    ...
                    desc1={t(
                      "Kılavuzsuz Eşiksiz Cam Balkon Sistemi balkonunuza hem estetik görüntü hem de perde takabilme olanağı sağlamaktadır. Diğer piyasa sistemleri gibi kısa zamanda çalışmama, açılmama, yürümeme, kapanmama gibi zorluklar yaşanmaz. Uzun yıllar kullanımı garanti eden bir sistemdir."
                    )}
...
export default KilavuzsuzEsiksizCamBalkon;
