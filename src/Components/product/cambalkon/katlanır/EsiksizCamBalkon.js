...
const EsiksizCamBalkon = () => {
  ...
  const pageKeywords = "Eşiksiz Cam Balkon Sistemleri";

  const [canonicalUrl, setCanonicalUrl] = useState("");

  useEffect(() => {
    const dynamicCanonicalUrl = "https://sekiryapi.com.tr/#/esiksiz-cam-balkon";
  ...
  return (
    <>
      <Helmet>
        <title>{t("Eşiksiz Cam Balkon Sistemleri")}</title>
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-store-features p-5">
                <ProductCarousel
                  title1={t("Eşiksiz Cam Balkon Sistemleri")}
                  picture1="assets/images/cam-balkon/katlanir-cam-balkon-sistemi/kcs/7.webp"
                  title2={t("Eşiksiz Cam Balkon Sistemleri")}
                  picture2="assets/images/cam-balkon/katlanir-cam-balkon-sistemi/kcs/8.webp"
                  title3={t("Eşiksiz Cam Balkon Sistemleri")}
                  picture3="assets/images/cam-balkon/katlanir-cam-balkon-sistemi/kcs/9.webp"
                  title4={t("Eşiksiz Cam Balkon Sistemleri")}
                  picture4="assets/images/cam-balkon/katlanir-cam-balkon-sistemi/kcs/21.webp"
                  title5={t("Eşiksiz Cam Balkon Sistemleri")}
                  picture5="assets/images/cam-balkon/katlanir-cam-balkon-sistemi/kcs/11.webp"
                  title6={t("Eşiksiz Cam Balkon Sistemleri")}
              ...
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-info-details pt-5">
                <ProductCarouselTitleSlogan
                  title={t("Eşiksiz Cam Balkon Sistemleri")}
                  slogan={t("")}
                />
              ...
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 product-info-details pt-5">
                ...
                <ul className="d-flex flex-column pro-lists product-price-info">
                  <ProductCarouselDescOne
                    title1={t("Yağmur Suyu")}
                    desc1={t(
                      "Tüm Eşiksiz sistemlerde kullanılabilen damlalık kasa profili ve sonradan montaj yapılabilen yağmur çıtası sayesinde cam balkonlarınıza yağmurun girmesine son verir."
                    )}
                  />
                </ul>
              </div>
...
export default EsiksizCamBalkon;
