        ...
        <section className="page-header">
          ...
          <div className="container">
            ...
            <h2 className="page-header__title">
              LEKE KARŞITI VE BEYAZLATICI CİLT BAKIM SERUMU
            </h2>
          </div>
        </section>
            ...
            <div className="row">
              ...
              >
                <div className="product-details__img">
                  <img
                    src="assets/images/lopren/beyazlatici-cilt-bakim-serumu.jpg"
                    alt=""
                  />
                  <div className="product-details__img-search">
                    <a
                      className="img-popup"
                      href="assets/images/lopren/beyazlatici-cilt-bakim-serumu.jpg"
                    ></a>
                  </div>
                </div>
              </div>
                  ...
                  <div className="product-details__excerpt">
                    <p className="list-unstyled product-details__description__lists">
                      <ul className="list-unstyled product-details__description__lists">
                        ...
                        Peptit, arbutin, meyan kökü ekstraktı ve niacinamide
                        içeren formülü ile koyu lekelerin görünümünün
                        azalmasına, cilt tonunun düzenlenmesine yardımcı olur.
