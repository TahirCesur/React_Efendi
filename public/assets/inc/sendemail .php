...
if ( $name && $senderEmail && $message ) {
  $recipient = "Tahir" . " <delenkar2825@gmail.com>";
  $headers = "From: " . $name . " <" . $senderEmail . ">";  
  $success = mail( $recipient, $mail_subject, $body, $headers );
  echo "<div class='inner success'><p class='success'>Bizimle iletişime geçtiğiniz için teşekkür ederiz. En kısa sürede sizinle iletişime geçeceğiz!</p></div>";
}else {
	echo "<div class='inner error'><p class='error'>Bir şeyler ters gitti. Lütfen tekrar deneyin.</p></div>";
}
